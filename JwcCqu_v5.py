...
class JwcCqu(object):
    ...
    def __init__(self):
        ...
        self.usr_name = '20183991'
        self.passwd = '135hualin'

        # self.intersted_list = ['高等数学', '体育', '大学物理']
        # self.teacher_list = ['冉锋', '曹术存', '魏华']
        self.intersted_list = ['健美操']
        self.teacher_list = ['关丽静']
    ...
    def login(self):
        state_url = 'http://202.202.1.41/_data/index_login.aspx'
    ...
    def open_selected_one(self, value, idx):
        url = "http://202.202.1.41/wsxk/stu_xszx_skbj.aspx?lx=BX&id=" + str(idx) + "&skbjval=" + ''
        ...
        for one_teacher_found in find_teacher_list:
            for teacher in self.teacher_list:
                if teacher in one_teacher_found:
                    ...
                    # change_value_list long_name->id && submit_data id->idx
